...
class BilingualDataset(data.Dataset):
...
#     src_mask = (src != self.pad_token).unsqueeze(0).unsqueeze(0).int()
#     tgt_mask = (tgt != self.pad_token).unsqueeze(0).unsqueeze(0).int() & self.causal_mask(tgt.size(1))
